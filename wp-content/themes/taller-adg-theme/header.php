...
<head>
	...
	<link href="<?php bloginfo('template_url'); ?>/style.css?ver=1.1.1" rel="stylesheet" type="text/css" />

	<?php wp_head(); ?>
</head>
<body class="<?php echo isset($opts['class']) ? $opts['class'] : '' ?>">
	<?php
...
<?php cltvo_superInc('/inc/menu.php', ['lang_code'	=> 	$lang_code]);  ?>
