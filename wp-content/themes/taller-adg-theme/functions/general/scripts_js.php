...
function cltvo_js(){
	wp_register_script( 'cltvo_functions_js', JSPATH.'functions.js', array('jquery', 'cltvo_masonry_js'/*'cltvo_scrollIt_js', 'cltvo_swiper_js','cltvo_validate_js', 'cltvo_validate_espanol_js'*/), false, true );
	...
	// wp_register_script( 'cltvo_imagesloaded_js', JSPATH.'imagesloaded.js', array('jquery'), false, true );
