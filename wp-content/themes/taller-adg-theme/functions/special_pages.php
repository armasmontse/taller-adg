...
$special_pages = array(
   __('inicio',TRANSDOMAIN)            => array( __('Inicio',TRANSDOMAIN), ''),
   __('acerca',TRANSDOMAIN)            => array( __('Acerca',TRANSDOMAIN), ''),
   __('contacto',TRANSDOMAIN)          => array( __('Contacto',TRANSDOMAIN), ''),
   __('arquitectura',TRANSDOMAIN)      => array( __('Arquitectura',TRANSDOMAIN), ''),
   __('diseno-interior',TRANSDOMAIN)   => array( __('Diseño Interior',TRANSDOMAIN), ''),
   __('diseno-grafico',TRANSDOMAIN)    => array( __('Diseño Gráfico',TRANSDOMAIN), ''),
   __('premios',TRANSDOMAIN)           => array( __('Premios',TRANSDOMAIN), ''),
   __('medios',TRANSDOMAIN)            => array( __('Medios',TRANSDOMAIN), ''),
   __('recostruccion',TRANSDOMAIN)     => array( __('Recostrucción',TRANSDOMAIN), '')
);
