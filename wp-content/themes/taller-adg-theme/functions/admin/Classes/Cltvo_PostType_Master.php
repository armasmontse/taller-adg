...
abstract class Cltvo_PostType_Master {
	...
	// se cargan las categorias
		$this->setTerms();
		// vd(get_class($this)); 
		// vd(class_exists('Cltvo_Architecture')); 
		// vd(method_exists(get_class(), 'rewriteSlug') ); 
		static::$rewrite = [
			'rewrite'	=> 	method_exists(static::class, 'rewriteSlug') ? static::rewriteSlug() : static::$rewrite
		];
	}
